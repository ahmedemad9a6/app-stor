...
import 'package:project_flutter_one/pages/catergories.dart';
                      ...
                      child: Row(
                        children: List.generate(category.length, (index) {
                          ...
                          return GestureDetector(
                            onTap: ()=> Navigator.push(context,MaterialPageRoute(builder: (index){ return Catergories();})) ,
                            child: Column(
                              children: [Image.asset(item.image, width: 75),
